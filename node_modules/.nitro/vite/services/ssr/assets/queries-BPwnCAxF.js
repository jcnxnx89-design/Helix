...
import { r as getSources } from "./sources.functions-BB9ryYGP.js";
import { z } from "zod";
import { queryOptions } from "@tanstack/react-query";
//#region src/lib/tmdb.functions.ts
var idInput = z.object({ id: z.number() });
...
var discover = createServerFn({ method: "GET" }).inputValidator(z.object({
...
createServerFn({ method: "GET" }).inputValidator(z.object({ type: z.enum(["movie", "tv"]) })).handler(createSsrRpc("ebf876321ff9fb76ab5e3e0145e843f93b8696f9dada1feaafa0882cc7a7fdef"));
...
var getSeason = createServerFn({ method: "GET" }).inputValidator(z.object({
	id: z.number(),
	season: z.number()
})).handler(createSsrRpc("a88edc453082894d652124c430c7a3d066602e628a6fac62288f02cf51c49f58"));
var getRecommendations = createServerFn({ method: "GET" }).inputValidator(z.object({
	id: z.number(),
	type: z.enum(["movie", "tv"])
})).handler(createSsrRpc("60377b0b957e359f55e5c9e6f48d2f5c6375bd2adfcc645f40f59d841be7b6df"));
var searchMedia = createServerFn({ method: "GET" }).inputValidator(z.object({ query: z.string() })).handler(createSsrRpc("4554bac009cb7b0dd4f23b35e6381cde80f8891f6cd2c529ecb25d91e64f42ba"));
//#endregion
